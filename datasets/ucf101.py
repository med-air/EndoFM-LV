...
from datasets.transform import VideoDataAugmentationDINO, VideoDataAugmentationCRC
...
class UCF101(torch.utils.data.Dataset):
    ...
    def _construct_loader(self):
        ...
        with open(path_to_file, "r") as f:
            ...
            # if self.mode in ["train"]:
            #     fraction = 1
            #     all_files = random.sample(all_files, len(all_files) * fraction // 100)

            for clip_idx, path_label in enumerate(all_files):
                assert (
    ...
    def __getitem__(self, index):
        ...
        for i_try in range(self._num_retries):
            ...
            #
            #     # Perform data augmentation.
            #     augmentation = VideoDataAugmentationCRC()
