...
def decode(
    ...
    if two_token:
        ...
        if rand_fr:
            # print(num_frames); exit(0)
            if num_frames == 16:
                global_1 = temporal_sampling(frames, 0, max_len - 5, 8)
                global_2 = temporal_sampling(frames, 5, max_len, 16)
            elif num_frames == 32:
                global_1 = temporal_sampling(frames, 0, max_len - 5, 16)
                global_2 = temporal_sampling(frames, 5, max_len, 32)
            elif num_frames == 64:
                global_1 = temporal_sampling(frames, 0, max_len - 5, 32)
                global_2 = temporal_sampling(frames, 5, max_len, 64)
            ...
            if num_frames == 16:
                ...
                num_local_frames = [4, 4, 8, 8, 16, 16, 32, 32]
            elif num_frames == 64:
                num_local_frames = [8, 8, 16, 16, 32, 32, 64, 64]
