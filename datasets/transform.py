...
class VideoDataAugmentationDINO(object):
    ...
    def __call__(self, image, from_list=False, no_aug=False, two_token=False):
        ...
        #
        # # global crops:
        # global_crop_1 = self.global_transform1(image[0])
        # global_crop_2 = self.global_transform2(image[1])
        #
        ...
        # # local crops:
        # local_crops = [
        #     self.local_transform(_) for _ in image[2:]
        # ]
...
class VideoDataAugmentationCRC(object):
    def __init__(self, global_crops_scale=(0.4, 1.0), local_crops_scale=(0.05, 0.4), local_crops_number=8):
        self.global_crops_scale = global_crops_scale
        self.local_crops_scale = local_crops_scale
        self.local_crops_number = local_crops_number
    ...
    def __call__(self, image, from_list=False, no_aug=False, two_token=False):
        ...
        # crops = self.global_transform2(image)
