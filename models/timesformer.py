...
#         x = xops.memory_efficient_attention(q, k, v, p=self.attn_drop_rate).transpose(1, 2).reshape(B, N, C)
#         # print(x.shape)
#         # exit(0)
#
#         if self.with_qkv:
...
class VisionTransformer(nn.Module):
    ...
    def forward_features(self, x, get_all=False, get_attn=False):
        ...
        patch_token = torch.mean(patch_token, 1)  # averaging predictions for every frame
